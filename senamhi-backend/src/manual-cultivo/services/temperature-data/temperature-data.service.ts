...
import { CreateTemperatureDataDto } from '../../dto/temperature-data/create-temperature-data.dto';
import { UpdateTemperatureDataDto } from '../../dto/temperature-data/update-temperature-data.dto';
